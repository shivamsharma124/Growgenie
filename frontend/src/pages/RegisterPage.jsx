...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Welcome to GrowGenie! 🎉 7-day free trial activated.");
      navigate("/dashboard");
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-[#0a0a0f] px-4 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-teal-400 opacity-10 blur-3xl" />
        ...
        <div className="bg-white dark:bg-[#12121a] border border-gray-100 dark:border-[#2a2a3d] rounded-2xl p-8 shadow-xl">
          <div className="text-center mb-7">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1 font-dm">
              Create your account — 7 days free trial
            </p>
          </div>

          {/* Free trial banner */}
          <div className="flex items-center gap-2 bg-teal-50 dark:bg-teal-500/10 border border-teal-100 dark:border-teal-500/20 rounded-xl px-3 py-2 mb-6 text-xs text-teal-700 dark:text-teal-400 font-dm">
